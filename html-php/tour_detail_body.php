				...
				<div class="col-xxl-8 col-lg-7">
					<div class="tour-details">
						...
						<div class="tour-img"><img
								src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/tour_details.jpg"
								alt="Tour Image"></div>
						<ul class="nav tour-tab" id="tourTab" role="tablist">
							<li class="nav-item" role="presentation"><a class="nav-link ot-btn active"
									...
									href="https://www.adivaha.com/themeforest-travon/tour-details.html#tourDescription"
									role="tab" aria-controls="tourDescription" aria-selected="true">Information</a></li>
							<li class="nav-item" role="presentation"><a class="nav-link ot-btn" id="plan-tab"
									data-bs-toggle="tab"
									href="https://www.adivaha.com/themeforest-travon/tour-details.html#plan" role="tab"
									aria-controls="plan" aria-selected="false">Tour Plan</a></li>
							<li class="nav-item" role="presentation"><a class="nav-link ot-btn" id="photos-tab"
									data-bs-toggle="tab"
									href="https://www.adivaha.com/themeforest-travon/tour-details.html#photos"
									role="tab" aria-controls="photos" aria-selected="false">Tour Photos</a></li>
							<li class="nav-item" role="presentation"><a class="nav-link ot-btn" id="location-tab"
									data-bs-toggle="tab"
									href="https://www.adivaha.com/themeforest-travon/tour-details.html#location"
									role="tab" aria-controls="location" aria-selected="false">Location</a></li>
						</ul>
						<div class="tab-content" id="productTabContent">
							<div class="tab-pane fade show active" id="tourDescription" role="tabpanel"
								...
								<div class="tour-description">
									...
									<p class="mt-n2 mb-4">Objectively leverage existing tactical core competencies for
										innovative innovation. Continually matrix unique resources for impactful
										solutions. Uniquely coordinate competitive e-tailers after resource maximizing
										benefits. Uniquely actualize principle-centered best practices rather than
										front-end testing procedures. Efficiently repurpose high-quality outsourcing
										vis-a-vis leading-edge schemas.</p>
									<p class="mb-30">Collaboratively predominate team building functionalities vis-a-vis
										holistic quality vectors. Appropriately plagiarize interdependent customer
										service without enterprise web-readiness. Holisticly formulate leading-edge
										resources through out-of-the-box internal or "organic" sources. Synergistically
										utilize user-centric opportunities after world-class ideas. Synergistically
										facilitate.</p>
									<div class="description-table-wrap">
										<table class="description-table">
											<tbody>
												...
												<tr>
													<th>Included</th>
													<td><span><i class="fal fa-check"></i> Specilaized Bilingual
															Guide</span><br><span><i class="fal fa-check"></i> Private
															Transport</span><br><span><i class="fal fa-check"></i>
															Entrance Fees</span><br><span><i class="fal fa-check"></i>
															Box Lunch,Water,Dinner and Snacks</span><br></td>
												</tr>
												<tr>
													<th>Excluded</th>
													<td><span><i class="fal fa-xmark"></i> Additional
															Services</span><br><span><i class="fal fa-xmark"></i>
															Insurance</span><br><span><i class="fal fa-xmark"></i>
															Drink</span><br><span><i class="fal fa-xmark"></i>
															Tickets</span><br></td>
												</tr>
											</tbody>
										</table>
							...
							<div class="tab-pane fade" id="photos" role="tabpanel" aria-labelledby="photos-tab">
								<div class="tour-photos">
									<div class="row g-4 masonary-active" style="position: relative; height: 0px;">
										<div class="col-md-6 filter-item"
											style="position: absolute; left: 0px; top: 0px;">
											<div class="tour-photo"><img
													src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/tour_inner_1.jpg"
													alt="Image"></div>
										</div>
										<div class="col-md-6 filter-item"
											style="position: absolute; left: 0px; top: 0px;">
											<div class="tour-photo"><img
													src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/tour_inner_2.jpg"
													alt="Image"></div>
										</div>
										<div class="col-md-6 filter-item"
											style="position: absolute; left: 0px; top: 0px;">
											<div class="tour-photo"><img
													src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/tour_inner_3.jpg"
													alt="Image"></div>
										</div>
										<div class="col-md-6 filter-item"
											style="position: absolute; left: 0px; top: 0px;">
											<div class="tour-photo"><img
													src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/tour_inner_4.jpg"
													alt="Image"></div>
										</div>
										<div class="col-md-6 filter-item"
											style="position: absolute; left: 0px; top: 0px;">
											<div class="tour-photo"><img
													src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/tour_inner_5.jpg"
													alt="Image"></div>
										</div>
									</div>
								</div>
							...
							<div class="tab-pane fade" id="location" role="tabpanel" aria-labelledby="location-tab">
								<div class="tour-location"><iframe
										src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/embed.html"
							...
							<div class="row">
								<div class="form-group rating-select d-flex align-items-center"><label>Your
									...
									<p class="stars"><span><a class="star-1"
												href="https://www.adivaha.com/themeforest-travon/tour-details.html#">1</a>
											<a class="star-2"
												href="https://www.adivaha.com/themeforest-travon/tour-details.html#">2</a>
											<a class="star-3"
												href="https://www.adivaha.com/themeforest-travon/tour-details.html#">3</a>
											<a class="star-4"
												href="https://www.adivaha.com/themeforest-travon/tour-details.html#">4</a>
											<a class="star-5"
												href="https://www.adivaha.com/themeforest-travon/tour-details.html#">5</a></span>
									</p>
								</div>
								<div class="col-12 form-group"><textarea placeholder="Write a Message"
										class="form-control" spellcheck="false" data-ms-editor="true"></textarea> <i
					...
					<aside class="sidebar-area">
						<div class="widget widget_book">
							<div class="widget-tour-book">
								...
								<form action="https://www.adivaha.com/themeforest-travon/mail.php" method="POST"
									class="widget-form">
									...
									<div class="form-group"><select name="subject" id="ticketType"
											class="form-select nice-select" style="display: none;">
											<option value="" disabled="disabled" selected="selected" hidden="">Ticket
												Types</option>
										...
										<div class="nice-select form-select" tabindex="0"><span class="current">Ticket
												Types</span>
											<ul class="list">
												<li data-value="" class="option selected disabled">Ticket Types</li>
												<li data-value="Basic Ticket" class="option">Basic Ticket</li>
												<li data-value="Standard Ticket" class="option">Standard Ticket</li>
												<li data-value="VIP Ticket" class="option">VIP Ticket</li>
											</ul>
										</div> <i class="fal fa-chevron-down"></i>
									</div>
									<div class="row">
										<div class="col-6 form-group"><select name="person" id="person"
												class="form-select nice-select" style="display: none;">
												<option value="" disabled="disabled" selected="selected" hidden="">Adult
												</option>
											...
											<div class="nice-select form-select" tabindex="0"><span
													class="current">Adult</span>
												<ul class="list">
													<li data-value="" class="option selected disabled">Adult</li>
													<li data-value="1 Person" class="option">1 Person</li>
													<li data-value="2 Person" class="option">2 Person</li>
													<li data-value="3 Person" class="option">3 Person</li>
												</ul>
											</div> <i class="fal fa-chevron-down"></i>
										</div>
										<div class="col-6 form-group"><select name="child" id="child"
												class="form-select nice-select" style="display: none;">
												<option value="" disabled="disabled" selected="selected" hidden="">Child
												</option>
												<option value="1 Person">1 Person</option>
												<option value="2 Person">2 Person</option>
												<option value="3 Person">3 Person</option>
											...
											<div class="nice-select form-select" tabindex="0"><span
													class="current">Child</span>
												<ul class="list">
													<li data-value="" class="option selected disabled">Child</li>
													<li data-value="1 Person" class="option">1 Person</li>
													<li data-value="2 Person" class="option">2 Person</li>
													<li data-value="3 Person" class="option">3 Person</li>
												</ul>
									...
									<div class="form-group"><input type="text" class="form-control" name="date"
											id="date" placeholder="mm/dd/yyyyy" spellcheck="false"
											data-ms-editor="true"> <i class="fal fa-calendar-alt"></i></div>
									<div class="form-group"><textarea name="message" id="message" cols="30" rows="3"
											class="form-control" placeholder="Your Message" spellcheck="false"
											data-ms-editor="true"></textarea> <i class="fal fa-pencil"></i></div>
						...
						<div class="widget">
							...
							<div class="recent-post-wrap">
								<div class="recent-post">
									<div class="media-img"><a
											href="https://www.adivaha.com/themeforest-travon/blog-details.html"><img
												src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/recent-tour-1-1.jpg"
												alt="Blog Image"></a></div>
									<div class="media-body">
										<h4 class="post-title"><a class="text-inherit"
												href="https://www.adivaha.com/themeforest-travon/blog-details.html">Brooklyn
								...
								<div class="recent-post">
									<div class="media-img"><a
											href="https://www.adivaha.com/themeforest-travon/blog-details.html"><img
												src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/recent-tour-1-2.jpg"
												alt="Blog Image"></a></div>
									<div class="media-body">
										<h4 class="post-title"><a class="text-inherit"
												href="https://www.adivaha.com/themeforest-travon/blog-details.html">Java
								...
								<div class="recent-post">
									<div class="media-img"><a
											href="https://www.adivaha.com/themeforest-travon/blog-details.html"><img
												src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/recent-tour-1-3.jpg"
												alt="Blog Image"></a></div>
									<div class="media-body">
										<h4 class="post-title"><a class="text-inherit"
												href="https://www.adivaha.com/themeforest-travon/blog-details.html">Places
												To Travel In November</a></h4><span class="tour-price">From <span
												class="price">250$</span></span>
									</div>
								</div>
								<div class="recent-post">
									...
									<div class="media-body">
										<h4 class="post-title"><a class="text-inherit"
												href="https://www.adivaha.com/themeforest-travon/blog-details.html">Pak
												Nam Chumphon Town Tour</a></h4><span class="tour-price">From <span
												class="price">250$</span></span>
									</div>
								</div>
							</div>
						...
						<div class="widget widget_banner">
							<div class="offer-banner">
								<div class="banner-logo"><img
										src="./Travon - Tour and Hotel Booking HTML Template - Tour details_files/logo-white.svg"
