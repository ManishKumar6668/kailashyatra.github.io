	...
	<section class="space">
		<div class="container">
			<div class="error-img"><img
					src="./Travon - Tour and Hotel Booking HTML Template - 404 - Error Page_files/error_img.svg"
					alt="404 image"></div>
			<div class="error-content">
				<h2 class="error-title">Opp’s that page can’t be found</h2>
				<p class="error-text">It looks like nothing was found at this location. The page or post you are looking
					for has been moved or removed.</p><a href="https://www.adivaha.com/themeforest-travon/index.html"
					class="ot-btn"><i class="fas fa-home me-2"></i>Back To Home</a>
			</div>
		</div>
	</section>
