			...
			<div class="row gy-40">
				<div class="col-xl-5">
					<div class="contact-info-wrap">
						<div class="shape-img"><img
								src="./Travon - Tour and Hotel Booking HTML Template - Contact Us_files/contact_shape.png"
								alt="shape"></div>
				...
				<div class="col-xl-7">
					<div class="contact-map"><iframe
							src="./Travon - Tour and Hotel Booking HTML Template - Contact Us_files/embed.html"
