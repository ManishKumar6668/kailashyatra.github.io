<footer class="footer-wrapper footer-layout1 background-image"
		style="background-image: url(&quot;assets/img/bg/footer_bg_1.png&quot;);">
						...
						<div class="widget footer-widget">
							<div class="ot-widget-about">
								...
								<p class="about-text">Globally communicate adaptive e-markets &amp; timely manufactured
									product. Objectively exploit collaborative relationships vis-a-vis competitive
									manufactured.</p>
								<div class="ot-social"><a href="https://www.facebook.com/"><i
											...
											class="fab fa-instagram"></i></a> <a href="https://www.whatsapp.com/"><i
						...
						<div class="widget widget_nav_menu footer-widget">
							...
							<div class="menu-all-pages-container">
								<ol class="menu">
									...
									<li><a
											href="destination.php">Destinations</a>
									</li>
				...
				<div class="row justify-content-between align-items-center">
					...
					<div class="col-lg-6 text-end d-none d-lg-block">
						<div class="footer-links">
							<ul>
								<li><a href="about.php">Terms of Use</a>
								</li>
								<li><a href="about.php">Privacy
	...
	<script
		src="./Travon - Tour and Hotel Booking HTML Template - Home Two_files/jquery-3.6.0.min.js"></script>
	<script src="./Travon - Tour and Hotel Booking HTML Template - Home Two_files/app.min.js"></script>
